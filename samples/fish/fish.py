"""
Mask R-CNN
Train on the toy Fish dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 fish.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>
...
class FishConfig(Config):
    """Configuration for training on fish dataset.
